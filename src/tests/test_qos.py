...
parse_funcs_invalid = [
        ...
        (qos.parse_duration, AttributeError, "not true"), # TODO improve error type
        (qos.parse_duration, AttributeError, ""),
        (qos.parse_duration, AttributeError, "test"),
        (qos.parse_duration, AttributeError, "1,1"),
        (qos.parse_duration, AttributeError, "(1,1"),
        (qos.parse_duration, AttributeError, "()"),
        (qos.parse_duration, AttributeError, "(,)"),
        (qos.parse_duration, AttributeError, "(1,)"),
        (qos.parse_duration, AttributeError, "(,1)"),
        (qos.parse_duration, AttributeError, "(1,1,1)"),
        (qos.parse_duration, AttributeError, "(1,1)1"),
        (qos.parse_duration, AttributeError, "dd(1,1)"),
        (qos.parse_duration, AttributeError, "(1,1)\n"),
        (qos.parse_duration, AttributeError, "\n(1,1)"),
        (qos.parse_duration, AttributeError, "(1\n,1)"),
        (qos.parse_duration, AttributeError, "(1,,1)"),
        (qos.parse_duration, AttributeError, "(1.0,1)"),
        (qos.parse_duration, AttributeError, "(1.0,1)"),
        (qos.parse_duration, AttributeError, "[1,,1]"),
        (qos.parse_duration, AttributeError, "Duration(1,1)"),
        ]
