...
from roserer.patterns.ars import (
        add_command_node,
        add_cyclic_node,
        add_fusion_node,
...
# Cyclic node
BehaviorPlanner = add_cyclic_node(e, "BehaviorPlanner", WCET, CYCLE_TIME,[
    "ObjectCollisionEstimator", "NDTLocalizer", "Lanelet2GlobalPlanner",
    "Lanelet2MapLoader", "ParkingPlanner", "LanePlanner"])

# Intersection node
EuclideanClusterDetector = add_intersection_node(e, "EuclideanClusterDetector", WCET, [
    ("RayGroundFilter", "EuclideanClusterDetector"),
    ("EuclideanClusterSettings", "EuclideanIntersection")
    ])

# Command node
VehicleDBWSystem = add_command_node(e, "VehicleDBWSystem", WCET, "VehicleInterface")
IntersectionOutput = add_command_node(e, "IntersectionOutput", WCET, "EuclideanIntersection")
